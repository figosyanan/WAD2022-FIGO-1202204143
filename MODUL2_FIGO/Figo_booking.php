...
<ul class="nav justify-content-center navbg">
  ...
  <div class="row g-0">
    <div class="col-md-6">
      <br><br><br><br><br><br><br><br>
        ...
        if (array_key_exists("honda", $_POST)) {
            echo '<img src="hrv.png" class="img-fluid rounded-start" alt="...">';
        } elseif (array_key_exists("toyota", $_POST)) {
            echo '<img src="fortuner.png" class="img-fluid rounded-start" alt="...">';
        } elseif (array_key_exists("mitsubishi", $_POST)) {
            echo '<img src="pajero.png" class="img-fluid rounded-start" alt="...">';
        } else {
            echo '<img src="pajero.png" class="img-fluid rounded-start" alt="...">';
        }
        ?>
   ...
   <div class="col-md-6">
    ...
    <form action="Figo_mybooking.php" method="POST">
        <div class= "mb-3">
        ...
        <br>
            ...
            <div class="mb-3">
        <button type="submit" class="btn btn-success btn btn-primary btn-lg btn-block" href="Figo_mybooking.php" height>Book</button>
    </form>
</div>
